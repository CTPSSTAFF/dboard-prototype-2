...
function generate_map_viz(towns, lottr) {
	...
	var tip = d3.tip()
	  ...
	  .offset([0, 10])
	  .html(function(d) {
	    return d.properties.route_num + "<br>AM LOTTR: " + d.properties.am_lottr + "<br>PM LOTTR: " + d.properties.pm_lottr;
	  });
	...
	var interstateSVG = svgContainer.selectAll(".interstate")
		...
		.enter()
		.append("path")
			.attr("class", function(d) { return d.tmc;})
			.attr("d", function(d, i) { return geoPath(d); })
			.style("fill", "#ddd")
			.style("stroke-width", function(d) { return (1/d.properties.am_lottr*5); })
			.style("stroke-linejoin", "round")
			.style("stroke", function(d) {
				// return colorScale(d.properties.am_lottr);
				return '#00ff00';
			})
